...
import pandas as pd
from src.function_scripts import add_choropleth_layer
from src.function_scripts import add_properties
import webbrowser
...
def draw_heatmap_streamlit(region_level="Okresy", property_layer="All", show_heatmap=True, selected_flat_types=None, area_range=(0, 200), price_range=(0, 100_000)):
    ...
    from src.function_scripts import filter_properties 
